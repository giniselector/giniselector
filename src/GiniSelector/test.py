...
from src.GiniSelector.scores import get_score_fn
...
def load_model_from_checkpoint(args: Arguments):
    ...
    score_fn = get_score_fn(args.score_fn)
    model = ModelWrapper(**model_essentials, root=args.checkpoints_dir, model_name=args.model_name, score_fn=score_fn)
...
def main(args: Arguments):
    ...
    for seed in range(1, 11, 1):
        ...
        helpers.append_results_to_file(results_obj, filename="results/individual_test_2.csv")
